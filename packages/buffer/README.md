...
This is the `buffer` library from NPM, vendored for use with Matanuska. In pure Node.js, this library is unnecessary. But something like this will be needed with QT.
