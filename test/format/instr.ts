...
const INSTRUCTIONS = [
  ...
  new End(),
  new Cd(new PathLiteral('..')),
  new Cp([new PathLiteral('foo.txt')], new PathLiteral('bar.txt'), true, true),
  new Cp(
    [new PathLiteral('foo.txt')],
    new PathLiteral('bar.txt'),
    false,
    false,
  ),
  new Rm([new PathLiteral('bar.txt')], false, false, false),
  new Rm([new PathLiteral('bar.txt')], true, true, true),
